...
public class UI_StatItem : MonoBehaviour
{
    ...
    StatUpgradeInfo GetUpgradeInfo(StatType type)
    {
        ...
        {
            case StatType.MaxHp:
                return new StatUpgradeInfo { title = "�ִ� ü��", price = 100, increase = 10 };
            case StatType.Attack:
                return new StatUpgradeInfo { title = "���ݷ�", price = 200, increase = 5 };
            case StatType.MaxMagazine:
                return new StatUpgradeInfo { title = "�ִ� źâ", price = 130, increase = 10 };
        }
        return default;
    }
